...
import { Coins, Wallet, Globe2, Rocket } from "lucide-react";

export const Token = () => {
  const tokenDetails = [
    { label: "Token Name", value: "Kanae (KNE)", icon: <Coins className="w-6 h-6" /> },
    { label: "Blockchain", value: "Solana (SOL)", icon: <Wallet className="w-6 h-6" /> },
    { label: "Total Supply", value: "10 billion KNE", icon: <Globe2 className="w-6 h-6" /> },
    { label: "Launch Platform", value: "Groupump.fun", icon: <Rocket className="w-6 h-6" /> },
  ];
